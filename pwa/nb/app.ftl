AudioDisabledNotification-text =
    <strong>{$displayName} dempet mikrofonen din.</strong>. Du kan skru på mikrofonen igjen når du vil.
...
ChatLogEvent-pip-auto-launch-description =
    Bilde-i-bilde ble automatisk skrudd på da du åpnet en link fra chat, så du fortsatt kan se de andre i møtet mens du fokuserer på noe annet.
...
InCallPeopleTab-breakout-started-by = Startet av {$name ->
        [you] deg
        *[other] {$name}
    }
...
LockSettings-lock-best-practices =
    Det lønner seg å holde rommet låst så ofte som mulig, både mens møter pågår og ellers. Dette gjør at du er trygg, og unngår uønskede gjester.
...
NewDeviceAddedNotification-title = En ny {$deviceType ->
    [audio] lydkilde
    *[video] videokilde
  } ble lagt til
...
OrgIncomplete-go-to-dashboard =
    Konfigurer subdomenet <strong>{$subdomain}</strong>
OrgIncomplete-text =
    Subdomenet <strong>{$subdomain}</strong> er ikke riktig konfigurert.
OrgIncomplete-title = Vi kan ikke finne rommet

OrgNotFound-go-to-signup =
    Opprett subdomenet <strong>{$subdomain}</strong>
OrgNotFound-text =
...
PreCallDevicePermissions-paragraph-devices-busy =
    Nettleseren din får ikke tilgang til kamera og mikrofon. <strong>Er de i bruk i en annen applikasjon?</strong>
...
PreCallReview-knock-status-hold =
    Du har blitt <strong>satt på vent</strong>. Vennligst vent på å bli sluppet inn.
...
PreCallReview-knock-text =
    <strong>Møteverten vil se bilde og navn når du banker på</strong>. Du vil slippe inn når alt er klart.
...
RequestAudioEnableAlert-text =
    {$displayName} inviterer deg til å prate. Skru på mikrofonen din når du er klar.
...
RequestVideoEnableAlert-text =
    {$displayName} inviterer deg til å delta. Skru på kameraet ditt når du er klar.
...
RoomBrandingInfoDialog-desc =
    Pro-abonnementet ditt lar deg tilpasse dine Whereby-rommet slik at ditt eget brand kommer tydelig fram i møter.
...
RoomLeftUpsell-license-based-business-banner-tagline = Fra USD 9.99 /mnd etter prøveperiode
RoomLeftUpsell-license-based-free-feature-group-meeting = Gruppemøter opp til 45 minutter
RoomLeftUpsell-license-based-free-feature-personal-meeting = Ubegrensede 1:1-møter
RoomLeftUpsell-license-based-free-feature-user = Inntil 100 deltakere
RoomLeftUpsell-license-based-pro-banner-cta = Prøv nå
RoomLeftUpsell-license-based-pro-cta = Prøv nå
RoomLeftUpsell-license-based-pro-feature-group-meeting = Ubegrensede gruppemøter
...
RoomNotFound-public-login-dashboard =
    Logg inn for å opprette dette rommet fra dashbordet
...
RoomNotFound-public-sign-up-to-create-room =
    Registrer deg uten kostnader for å opprette et rom
...
RoomSizeSettings-confirm-desc = Du og {$numOtherParticipants} {$numOtherParticipants ->
        [one] annen deltaker
...
TempRecWarningNotification-title = Du har {$temporaryRecordingsCount}  {$temporaryRecordingsCount ->
        [one] ulagret
        *[other] ulagrede
    } opptak!

TimingSectionTooltip-text = Gruppesamtaler i gratisrom er tidsbegrenset: <strong>{$minutesLeft ->
...
VideoDisabledNotification-text =
    <strong>{$displayName} skrudde av kameraet ditt.</strong> Du kan skru på kameraet ditt igjen når du vil.
