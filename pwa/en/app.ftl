...
PreCallNamePrompt-terms-of-service-text-age-warning = By using this service you agree to our <toslink>Terms of Service</toslink> and confirm that you are older than 16 years.
...
PreCallReview-knock-text = <strong>Your camera will take a photo when you knock.</strong> The photo and your name will be shown to the host.
...
RequestVideoEnableAlert-text = { $displayName } invites you to join the stage. Turn your camera on when ready.
...
TempRecWarningNotification-title =
    You have { $temporaryRecordingsCount } unsaved { $temporaryRecordingsCount ->
        [one] recording
       *[other] recordings
    }!

TimingSectionTooltip-text =
    Group calls on the Free plan are time limited: <strong>{ $minutesLeft ->
